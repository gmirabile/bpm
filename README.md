...
| ----------------- | --------------------------------- | ------------ | ------------------------------------------------- |
| **candidateData** | `it.ariaspa.sireal20.kogito.hr.CandidateData` | **input**    | The candidate data                                |
| **offer**         | `it.ariaspa.sireal20.kogito.hr.Offer`         | **output**   | The generated candidate offer                     |
...
as an input and will produce an instance of `it.ariaspa.sireal20.kogito.hr.Offer` that will be stored in the `offer` variable.
